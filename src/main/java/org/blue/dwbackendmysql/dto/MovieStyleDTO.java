...
public class MovieStyleDTO {
    ...
    public MovieStyleDTO(String movieName, int runTime, Integer commentNum, String type, Float grade, Integer year, Integer month, Integer day) {
